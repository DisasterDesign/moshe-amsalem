...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      {/* 3D Background */}
      <div className="absolute inset-0 z-0 pointer-events-none md:pointer-events-auto opacity-80">
        <ScalesModel />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center pt-[30px] md:pt-0 md:justify-center min-h-screen text-center px-4 pointer-events-none">
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center gap-4 mt-[140px] md:mt-10 pointer-events-auto"
        >
          <Link
            href="/contact"
